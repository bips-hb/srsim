...
#' set from \code{simulateSRDAG}. The tables are organized 
#' as follows: 
#' \tabular{lccc}{
...
#' }
#' 
#' @param sr The output generated by the \code{simulateSRDAG} function 
#'
...
#'   \item{\code{beta}}{The beta value between the drug and event}
...
create2x2TablesDAG <- function(sr) {
  return(dplyr::as_tibble(
    create2x2TablesDAGRcpp(as.matrix(sr$sr), sr$adjecency_matrix, sr$prob_drugs, sr$prob_events) 
  ))
}